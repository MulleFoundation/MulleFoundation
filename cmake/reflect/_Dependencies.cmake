...
if( NOT MULLE_OBJC_DECIMAL_FOUNDATION_LIBRARY)
   ...
   if( MULLE_OBJC_DECIMAL_FOUNDATION_LIBRARY)
      ...
      # Disable with: `mulle-sourcetree mark MulleObjCDecimalFoundation no-cmakeadd`
      #
      set( ALL_LOAD_DEPENDENCY_LIBRARIES
         ${ALL_LOAD_DEPENDENCY_LIBRARIES}
      ...
      #
      # Inherit ObjC loader and link dependency info.
      # Disable with: `mulle-sourcetree mark MulleObjCDecimalFoundation no-cmakeinherit`
      #
      # // temporarily expand CMAKE_MODULE_PATH
      ...
      #
      # Search for "DependenciesAndLibraries.cmake" to include.
      # Disable with: `mulle-sourcetree mark MulleObjCDecimalFoundation no-cmakedependency`
      #
      ...
      #
      # Search for "MulleObjCLoader+<name>.h" in include directory.
      # Disable with: `mulle-sourcetree mark MulleObjCDecimalFoundation no-cmakeloader`
      #
      if( NOT NO_INHERIT_OBJC_LOADERS)
         foreach( _TMP_MULLE_OBJC_DECIMAL_FOUNDATION_NAME "MulleObjCDecimalFoundation")
...
if( NOT MULLE_OBJC_CALENDAR_FOUNDATION_LIBRARY)
   ...
   if( MULLE_OBJC_CALENDAR_FOUNDATION_LIBRARY)
      ...
      # Disable with: `mulle-sourcetree mark MulleObjCCalendarFoundation no-cmakeadd`
      #
      set( ALL_LOAD_DEPENDENCY_LIBRARIES
         ${ALL_LOAD_DEPENDENCY_LIBRARIES}
      ...
      #
      # Inherit ObjC loader and link dependency info.
      # Disable with: `mulle-sourcetree mark MulleObjCCalendarFoundation no-cmakeinherit`
      #
      # // temporarily expand CMAKE_MODULE_PATH
      ...
      #
      # Search for "DependenciesAndLibraries.cmake" to include.
      # Disable with: `mulle-sourcetree mark MulleObjCCalendarFoundation no-cmakedependency`
      #
      ...
      #
      # Search for "MulleObjCLoader+<name>.h" in include directory.
      # Disable with: `mulle-sourcetree mark MulleObjCCalendarFoundation no-cmakeloader`
      #
      if( NOT NO_INHERIT_OBJC_LOADERS)
         foreach( _TMP_MULLE_OBJC_CALENDAR_FOUNDATION_NAME "MulleObjCCalendarFoundation")
...
if( NOT MULLE_OBJC_MATH_FOUNDATION_LIBRARY)
   ...
   if( MULLE_OBJC_MATH_FOUNDATION_LIBRARY)
      ...
      # Disable with: `mulle-sourcetree mark MulleObjCMathFoundation no-cmakeadd`
      #
      set( ALL_LOAD_DEPENDENCY_LIBRARIES
         ${ALL_LOAD_DEPENDENCY_LIBRARIES}
      ...
      #
      # Inherit ObjC loader and link dependency info.
      # Disable with: `mulle-sourcetree mark MulleObjCMathFoundation no-cmakeinherit`
      #
      # // temporarily expand CMAKE_MODULE_PATH
      ...
      #
      # Search for "DependenciesAndLibraries.cmake" to include.
      # Disable with: `mulle-sourcetree mark MulleObjCMathFoundation no-cmakedependency`
      #
      ...
      #
      # Search for "MulleObjCLoader+<name>.h" in include directory.
      # Disable with: `mulle-sourcetree mark MulleObjCMathFoundation no-cmakeloader`
      #
      if( NOT NO_INHERIT_OBJC_LOADERS)
         foreach( _TMP_MULLE_OBJC_MATH_FOUNDATION_NAME "MulleObjCMathFoundation")
...
if( NOT MULLE_OBJC_UNICODE_FOUNDATION_LIBRARY)
   ...
   if( MULLE_OBJC_UNICODE_FOUNDATION_LIBRARY)
      ...
      # Disable with: `mulle-sourcetree mark MulleObjCUnicodeFoundation no-cmakeadd`
      #
      set( ALL_LOAD_DEPENDENCY_LIBRARIES
         ${ALL_LOAD_DEPENDENCY_LIBRARIES}
      ...
      #
      # Inherit ObjC loader and link dependency info.
      # Disable with: `mulle-sourcetree mark MulleObjCUnicodeFoundation no-cmakeinherit`
      #
      # // temporarily expand CMAKE_MODULE_PATH
      ...
      #
      # Search for "DependenciesAndLibraries.cmake" to include.
      # Disable with: `mulle-sourcetree mark MulleObjCUnicodeFoundation no-cmakedependency`
      #
      ...
      #
      # Search for "MulleObjCLoader+<name>.h" in include directory.
      # Disable with: `mulle-sourcetree mark MulleObjCUnicodeFoundation no-cmakeloader`
      #
      if( NOT NO_INHERIT_OBJC_LOADERS)
         foreach( _TMP_MULLE_OBJC_UNICODE_FOUNDATION_NAME "MulleObjCUnicodeFoundation")
