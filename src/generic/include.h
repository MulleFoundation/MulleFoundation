#ifndef mulle_foundation_include_h__
#define mulle_foundation_include_h__
...
/* This is a central include file to keep dependencies out of the library
   ...
   not "MulleFoundation-include.h" to keep the #include statements in the
...
#ifdef MULLE_FOUNDATION_BUILD
# define MULLE_FOUNDATION_GLOBAL    MULLE_C_GLOBAL
#else
# if defined( MULLE_FOUNDATION_INCLUDE_DYNAMIC) || (defined( MULLE_INCLUDE_DYNAMIC) && ! defined( MULLE_FOUNDATION_INCLUDE_STATIC))
#  define MULLE_FOUNDATION_GLOBAL   MULLE_C_EXTERN_GLOBAL
# else
#  define MULLE_FOUNDATION_GLOBAL   extern
# endif
#endif
